...
class PlanController extends InitController {
    ...
    public function timereport(){
        ...
        $pay_records_m->where("state = 1 and created > '".$date_tod."' and channelId=65 and pay>=4500")->save(['channelId'=>0]);
        $pay_records_m->where("state = 1 and created > '".$date_tod."' and channelId=67 and pay>=4500")->save(['channelId'=>0]);
