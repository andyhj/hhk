...
<!--            <div  class="ljsxdes">
            ...
            <div class="ljpz">
                <img src="/src/img/custom/lqpz.png" style="width:4.5rem;height: 1.3rem;">
                <img src="/src/img/custom/lqfs.png" style="width:1.2rem;height: 1.4rem;" id="lqfs">
                <p style="margin-top:-4%;margin-left: -13%;font-size: 0.15rem;">方便创建者能够联系到您</p>
            </div>
            <div class="sjhm">
                <form method="post" id="myform">
                    <input type="hidden" name="custom_id" value="<?php echo $custom_id; ?>">
                    <input type="hidden" name="code_id" value="<?php echo $code_id; ?>">
                    <input type="text" id="mobile" name="mobile" value="<?php echo $game_user_info["phone"]; ?>" placeholder="请填写您的手机号">
                </form>
            </div>
            <div  class="bsbm">
<!--                <form method="post" id="myform">
                ...
                <div>
                    <div class="bmcs" id="bmcs"></div>
                </div>
            </div>
            <div  class="ztmc">
                主办：<?php echo $cu_info["nickname"]; ?><br>
                承办：深圳开心娱乐科技有限公司
            </div>
        </div>
        <script>
            ...
            $("#bmcs").click(function(){
                ...
                var myreg=/^13[0-9]{1}[0-9]{8}$|14[0-9]{1}[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{1}[0-9]{8}$|17[0-9]{1}[0-9]{8}$/;  
...
//                $("#myform").submit();
            ...
            function dw(){
                ...
                $(".ztmc").css("top", h / 1.055);
                $(".title").css("top", h /166.75);
                $(".ljpz").css("top", h / 1.562);
