    ...
    <head>
        ...
        <script>
            function exchange(type){
                if(confirm("确定已领取到奖品？")){
                    window.location="<?php echo $url."?id=".$rankingInfo["id"];?>&type="+type;
                }
            }
        </script>
    </head>
                    ...
                    <li>
                        <div class="ranking">
                            <table style="margin: 0px;font-size: 14px;">
                                ...
                                <?php }?>
                                <tr>
                                    <td><span>创建者：<?php echo $cUserInfo["nickname"];?></span></td>
                                </tr>
                                <tr>
                                    <td><span>联系电话：<?php echo $cUserInfo["mobile"]?$cUserInfo["mobile"]:$cUserInfo["phone"];?></span></td>
                                </tr>
                                <tr>
                                ...
                                <?php if($rankingInfo['prizes1_exchange']==1){?>
                                <tr>
                                    <td align="center">
                                        <input type="button" onclick="exchange(1)" value="领 取" style="margin: 15px;width: 30%;height: 35px;font-size: 18px;border: 0px;background-color: #fdc158;border-radius: 5px;">
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
                                ...
                                <?php if($rankingInfo['prizes2_exchange']==1){?>
                                <tr>
                                    <td align="center">
                                        <input type="button" onclick="exchange(2)" value="领 取" style="margin: 15px;width: 30%;height: 35px;font-size: 18px;border: 0px;background-color: #fdc158;border-radius: 5px;">
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
                                ...
                                <?php if($rankingInfo['prizes3_exchange']==1){?>
                                <tr>
                                    <td align="center">
                                        <input type="button" onclick="exchange(3)" value="领 取" style="margin: 15px;width: 30%;height: 35px;font-size: 18px;border: 0px;background-color: #fdc158;border-radius: 5px;">
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
                                ...
                                <?php if($rankingInfo['prizes4_exchange']==1){?>
                                <tr>
                                    <td align="center">
                                        <input type="button" onclick="exchange(4)" value="领 取" style="margin: 15px;width: 30%;height: 35px;font-size: 18px;border: 0px;background-color: #fdc158;border-radius: 5px;">
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
                                ...
                                <?php if($rankingInfo['prizes5_exchange']==1){?>
                                <tr>
                                    <td align="center">
                                        <input type="button" onclick="exchange(5)" value="领 取" style="margin: 15px;width: 30%;height: 35px;font-size: 18px;border: 0px;background-color: #fdc158;border-radius: 5px;">
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
                                ...
                                <?php if($rankingInfo['join_prizes_exchange']==1){?>
                                <tr>
                                    <td align="center">
                                        <input type="button" onclick="exchange(6)" value="领 取" style="margin: 15px;width: 30%;height: 35px;font-size: 18px;border: 0px;background-color: #fdc158;border-radius: 5px;">
                                    </td>
                                </tr>
                                <?php }?>
                                <?php }?>
