...
class class_weixin_adv
{
    ...
    //生成参数二维码
    public function create_qrcode_url($scene_type, $scene_id,$scene_str)
    {
        switch($scene_type)
        {
            case 1: //永久
                ...
                break;
            case 0:       //临时
                $data = '{"expire_seconds": 1800, "action_name": "QR_SCENE", "action_info": {"scene": {"scene_id": '.$scene_id.',"scene_str":"'.$scene_str.'"}}}';
                break;
        }
        $url = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=".$this->access_token;
        $res = $this->https_request($url, $data);
    ...
    //oauth2授权
    public function oauth2($appid, $redirect_uri)
    {
