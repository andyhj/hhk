...
use Common\WxApi\WxPayConfig;
use Common\WxApi\WxPayUnifiedOrder;
use Common\WxApi\WxPayException;
require_once APP_ROOT ."Application/Common/Concrete/wxapi/lib/WxPay.Exception.php";
require_once APP_ROOT ."Application/Common/Concrete/wxapi/lib/WxPay.Config.php";
require_once APP_ROOT ."Application/Common/Concrete/wxapi/lib/WxPay.Data.php";
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if(!$inputObj->GetAppid()&&!$inputObj->GetMch_id()){
